...
public interface IPostController {
	...
	public RootEntity<DtoPostSlice> getFeed(PostType type, Double lat, Double lng, Integer radius, String cursor,
			Integer pageSize);

	public RootEntity<Boolean> deletePost(Integer postId);

	// PART 2: Akışta "en son görülenden" bu yana kaç yeni post var (rozet için).
	public RootEntity<Long> getNewPostCount();

	// PART 2: "En son görülen" işaretini verilen post id'sine ilerlet.
	public RootEntity<Boolean> markFeedSeen(Integer postId);
